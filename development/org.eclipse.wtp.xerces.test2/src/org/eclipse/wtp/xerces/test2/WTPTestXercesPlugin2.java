...
public class WTPTestXercesPlugin2 extends Plugin {
	...
	private static WTPTestXercesPlugin2 INSTANCE;

	/**
	 * Return the singleton JPT plug-in.
	 */
	public static WTPTestXercesPlugin2 instance() {
		return INSTANCE;
	}
