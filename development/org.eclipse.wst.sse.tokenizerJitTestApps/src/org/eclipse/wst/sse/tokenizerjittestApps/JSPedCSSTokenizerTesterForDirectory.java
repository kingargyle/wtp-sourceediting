 ...
 * 
 */
public class JSPedCSSTokenizerTesterForDirectory extends TokenizerTesterForDirectory {

	static final String tokenizerName = "JSPedCSSTokenizer";

	@Override
	protected void doTest(final Reader reader) throws IOException {

		final JSPedCSSTokenizer tokenizer = new JSPedCSSTokenizer(reader);
	...
	private void scanThroughFile(final JSPedCSSTokenizer tokenizer) throws IOException {
