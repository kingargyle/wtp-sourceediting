...
import org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint;
...
import org.eclipse.wst.jsdt.debug.eval.IEvaluationListener;
import org.eclipse.wst.jsdt.debug.eval.IEvaluationResult;
...
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIStackFrame;
...
public class JavaLineBreakpoint extends JavaBreakpoint implements IJavaLineBreakpoint {
	 ...
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.condition"</code>). This attribute is stored as a
	 * <code>String</code>.
	 */
	protected static final String CONDITION= "org.eclipse.wst.jsdt.debug.core.condition"; //$NON-NLS-1$
	/**
	 * Breakpoint attribute storing a breakpoint's condition enablement
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.conditionEnabled"</code>). This attribute is stored as an
	 * <code>boolean</code>.
	 */
	protected static final String CONDITION_ENABLED= "org.eclipse.wst.jsdt.debug.core.conditionEnabled"; //$NON-NLS-1$
	
	/**
	 * Breakpoint attribute storing a breakpoint's condition suspend policy
	 * (value <code>" org.eclipse.wst.jsdt.debug.core.conditionSuspendOnTrue"
	 * </code>). This attribute is stored as an <code>boolean</code>.
	 */
	protected static final String CONDITION_SUSPEND_ON_TRUE= "org.eclipse.wst.jsdt.debug.core.conditionSuspendOnTrue"; //$NON-NLS-1$
	
	/**
	 * Breakpoint attribute storing a breakpoint's source file name (debug attribute)
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.sourceName"</code>). This attribute is stored as
	 * a <code>String</code>.
	 */
	protected static final String SOURCE_NAME= "org.eclipse.wst.jsdt.debug.core.sourceName";	 //$NON-NLS-1$

	private static final String JAVA_LINE_BREAKPOINT = "org.eclipse.wst.jsdt.debug.javaLineBreakpointMarker"; //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#addToTarget(org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#removeFromTarget(org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#newRequest(org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget, com.sun.jdi.ReferenceType)
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#handleBreakpointEvent(com.sun.jdi.event.Event, org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget, org.eclipse.wst.jsdt.internal.debug.core.model.JDIThread)
	 * 
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#supportsCondition()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#getCondition()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#setCondition(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#isConditionEnabled()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#setConditionEnabled(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#cleanupForThreadTermination(org.eclipse.wst.jsdt.internal.debug.core.model.JDIThread)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#addInstanceFilter(com.sun.jdi.request.EventRequest, com.sun.jdi.ObjectReference)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#isConditionSuspendOnTrue()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaLineBreakpoint#setConditionSuspendOnTrue(boolean)
	 */
