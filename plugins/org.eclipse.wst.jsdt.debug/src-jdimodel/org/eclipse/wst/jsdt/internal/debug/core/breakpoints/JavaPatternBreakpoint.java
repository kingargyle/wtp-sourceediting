...
import org.eclipse.wst.jsdt.debug.core.IJavaPatternBreakpoint;
...
public class JavaPatternBreakpoint extends JavaLineBreakpoint implements IJavaPatternBreakpoint {
	...
	private static final String PATTERN_BREAKPOINT = "org.eclipse.wst.jsdt.debug.javaPatternBreakpointMarker"; //$NON-NLS-1$
	
	/**
	 * Breakpoint attribute storing the pattern identifier of the source
	 * file in which a breakpoint is created
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.pattern"</code>). This attribute is a <code>String</code>.
	 */
	protected static final String PATTERN = "org.eclipse.wst.jsdt.debug.core.pattern"; //$NON-NLS-1$	
