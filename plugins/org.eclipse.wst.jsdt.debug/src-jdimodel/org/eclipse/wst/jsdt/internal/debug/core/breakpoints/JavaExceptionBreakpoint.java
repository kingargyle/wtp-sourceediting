...
import org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint;
...
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIValue;
...
public class JavaExceptionBreakpoint extends JavaBreakpoint implements IJavaExceptionBreakpoint {
	...
	private static final String JAVA_EXCEPTION_BREAKPOINT= "org.eclipse.wst.jsdt.debug.javaExceptionBreakpointMarker"; //$NON-NLS-1$
	
	/**
	 * Exception breakpoint attribute storing the suspend on caught value
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.caught"</code>). This attribute is stored as a <code>boolean</code>.
	 * When this attribute is <code>true</code>, a caught exception of the associated
	 * type will cause excecution to suspend .
	 */
	protected static final String CAUGHT = "org.eclipse.wst.jsdt.debug.core.caught"; //$NON-NLS-1$
	/**
	 * Exception breakpoint attribute storing the suspend on uncaught value
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.uncaught"</code>). This attribute is stored as a
	 ...
	 */
	protected static final String UNCAUGHT = "org.eclipse.wst.jsdt.debug.core.uncaught"; //$NON-NLS-1$	
	/**
	 * Exception breakpoint attribute storing the checked value (value <code>"org.eclipse.wst.jsdt.debug.core.checked"</code>).
	 * This attribute is stored as a <code>boolean</code>, indicating whether an
	 * exception is a checked exception.
	 */
	protected static final String CHECKED = "org.eclipse.wst.jsdt.debug.core.checked"; //$NON-NLS-1$	
	
	/**
	 * Exception breakpoint attribute storing the String value (value <code>"org.eclipse.wst.jsdt.debug.core.filters"</code>).
	 ...
	 * INCLUSIVE_FILTERS.
	 */
	protected static final String INCLUSION_FILTERS = "org.eclipse.wst.jsdt.debug.core.inclusion_filters"; //$NON-NLS-1$	
	 ...
	 * INCLUSIVE_FILTERS.
	 */
	protected static final String EXCLUSION_FILTERS = "org.eclipse.wst.jsdt.debug.core.exclusion_filters"; //$NON-NLS-1$	
	/**
	 * Allows the user to specify whether we should suspend if subclasses of the specified exception are thrown/caught
	 * @since 3.2
	 */
	protected static final String SUSPEND_ON_SUBCLASSES = "org.eclipse.wst.jsdt.debug.core.suspend_on_subclasses"; //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#setSuspendOnSubclasses(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#isSuspendOnSubclasses()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#setInstalledIn(org.eclipse.wst.jsdt.debug.core.IJavaDebugTarget, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#getExceptionTypeName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#configureRequest(com.sun.jdi.request.EventRequest, org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#getExclusionFilters()
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#getInclusionFilters()
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#setExclusionFilters(String[])
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaExceptionBreakpoint#setInclusionFilters(String[])
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#addInstanceFilter(EventRequest, ObjectReference)
	 */
