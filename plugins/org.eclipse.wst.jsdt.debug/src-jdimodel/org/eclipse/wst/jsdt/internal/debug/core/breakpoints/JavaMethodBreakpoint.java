...
import org.eclipse.wst.jsdt.debug.core.IJavaMethodBreakpoint;
...
public class JavaMethodBreakpoint extends JavaLineBreakpoint implements IJavaMethodBreakpoint {
	...
	private static final String JAVA_METHOD_BREAKPOINT = "org.eclipse.wst.jsdt.debug.javaMethodBreakpointMarker"; //$NON-NLS-1$
	
	/**
	 * Breakpoint attribute storing the name of the method
	 * in which a breakpoint is contained.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.methodName"</code>). 
	 * This attribute is a <code>String</code>.
	 */
	private static final String METHOD_NAME = "org.eclipse.wst.jsdt.debug.core.methodName"; //$NON-NLS-1$	
	
	/**
	 * Breakpoint attribute storing the signature of the method
	 * in which a breakpoint is contained.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.methodSignature"</code>). 
	 * This attribute is a <code>String</code>.
	 */
	private static final String METHOD_SIGNATURE = "org.eclipse.wst.jsdt.debug.core.methodSignature"; //$NON-NLS-1$	
	
	/**
	 * Breakpoint attribute storing whether this breakpoint
	 * is an entry breakpoint.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.entry"</code>).
	 * This attribute is a <code>boolean</code>.
	 */
	private static final String ENTRY = "org.eclipse.wst.jsdt.debug.core.entry"; //$NON-NLS-1$	

	/**
	 * Breakpoint attribute storing whether this breakpoint
	 * is an exit breakpoint.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.exit"</code>).
	 * This attribute is a <code>boolean</code>.
	 */
	private static final String EXIT = "org.eclipse.wst.jsdt.debug.core.exit"; //$NON-NLS-1$	
		
	/**
	 * Breakpoint attribute storing whether this breakpoint
	 * only applies to native methods.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.native"</code>).
	 * This attribute is a <code>boolean</code>.
	 */
	private static final String NATIVE = "org.eclipse.wst.jsdt.debug.core.native"; //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaMethodEntryBreakpoint#getMethodName()		
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaMethodEntryBreakpoint#getMethodSignature()		
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#removeFromTarget(JDIDebugTarget)
	 */
	 ...
	 * pattern matching).
	 * 
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#createRequest(JDIDebugTarget, ReferenceType)
	 */
	...
	/**
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#setTypeName(String)
	 */
