...
import org.eclipse.wst.jsdt.debug.core.IJavaClassPrepareBreakpoint;
...
public class JavaClassPrepareBreakpoint extends JavaBreakpoint implements IJavaClassPrepareBreakpoint {
	...
	private static final String JAVA_CLASS_PREPARE_BREAKPOINT= "org.eclipse.wst.jsdt.debug.javaClassPrepareBreakpointMarker"; //$NON-NLS-1$
	
	/**
	 * Class prepare breakpoint attribute storing the type of member this
	 * breakpoint is associated with
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.memberType"</code>), encoded
	 * as an integer.
	 */
	protected static final String MEMBER_TYPE = "org.eclipse.wst.jsdt.debug.core.memberType"; //$NON-NLS-1$
	 ...
	 * Not supported for class prepare breakpoints.
	 * 
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#setRequestThreadFilter(com.sun.jdi.request.EventRequest, com.sun.jdi.ThreadReference)
	 */
	protected void setRequestThreadFilter(EventRequest request, ThreadReference thread) {
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.breakpoints.JavaBreakpoint#handleClassPrepareEvent(com.sun.jdi.event.ClassPrepareEvent, org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaClassPrepareBreakpoint#getMemberType()
	 */
