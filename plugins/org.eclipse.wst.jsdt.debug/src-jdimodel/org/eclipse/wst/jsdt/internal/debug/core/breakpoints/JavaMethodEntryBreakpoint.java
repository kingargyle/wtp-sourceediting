...
import org.eclipse.wst.jsdt.debug.core.IJavaMethodEntryBreakpoint;
...
public class JavaMethodEntryBreakpoint extends JavaLineBreakpoint implements IJavaMethodEntryBreakpoint {
	...
	private static final String JAVA_METHOD_ENTRY_BREAKPOINT = "org.eclipse.wst.jsdt.debug.javaMethodEntryBreakpointMarker"; //$NON-NLS-1$
	
	/**
	 * Breakpoint attribute storing the name of the method
	 * in which a breakpoint is contained.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.methodName"</code>). This attribute is a <code>String</code>.
	 */
	 ...
	 * in which a breakpoint is contained.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.methodSignature"</code>). This attribute is a <code>String</code>.
	 */
