 ...
 *******************************************************************************/
package org.eclipse.wst.jsdt.internal.debug.core.breakpoints;
...
import org.eclipse.wst.jsdt.internal.debug.core.IJDIEventListener;
import org.eclipse.wst.jsdt.internal.debug.core.JDIDebugPlugin;
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget;
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIObjectValue;
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIThread;
import org.eclipse.wst.jsdt.internal.debug.core.model.JDIType;
...
public abstract class JavaBreakpoint extends Breakpoint implements IJavaBreakpoint, IJDIEventListener, IDebugEventSetListener {
	...
	/**
	 * Breakpoint attribute storing the expired value (value <code>"org.eclipse.wst.jsdt.debug.core.expired"</code>).
	 ...
	 */
	protected static final String EXPIRED = "org.eclipse.wst.jsdt.debug.core.expired"; //$NON-NLS-1$
	/**
	 * Breakpoint attribute storing a breakpoint's hit count value
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.hitCount"</code>). This attribute is stored as an
	 * <code>int</code>.
	 */
	protected static final String HIT_COUNT = "org.eclipse.wst.jsdt.debug.core.hitCount"; //$NON-NLS-1$
	/**
	 * Breakpoint attribute storing the number of debug targets a
	 * breakpoint is installed in (value <code>"org.eclipse.wst.jsdt.debug.core.installCount"</code>).
	 * This attribute is a <code>int</code>.
	 */
	protected static final String INSTALL_COUNT = "org.eclipse.wst.jsdt.debug.core.installCount"; //$NON-NLS-1$	
	
	/**
	 * Breakpoint attribute storing the fully qualified name of the type
	 * this breakpoint is located in.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.typeName"</code>). This attribute is a <code>String</code>.
	 */
	protected static final String TYPE_NAME = "org.eclipse.wst.jsdt.debug.core.typeName"; //$NON-NLS-1$		
	
	/**
	 * Breakpoint attribute storing suspend policy code for 
	 * this breakpoint.
	 * (value <code>"org.eclipse.wst.jsdt.debug.core.suspendPolicy</code>).
	 ...
	 */
	protected static final String SUSPEND_POLICY = "org.eclipse.wst.jsdt.debug.core.suspendPolicy"; //$NON-NLS-1$			
	 ...
	 */
	public static final String JAVA_BREAKPOINT_PROPERTY = "org.eclipse.wst.jsdt.debug.breakpoint"; //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.IJDIEventListener#handleEvent(com.sun.jdi.event.Event, org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.core.IJDIEventListener#wonSuspendVote(com.sun.jdi.event.Event, org.eclipse.wst.jsdt.internal.debug.core.model.JDIDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#isInstalled()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getTypeName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getHitCount()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#setHitCount(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getSuspendPolicy()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#setSuspendPolicy(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#setThreadFilter(org.eclipse.wst.jsdt.debug.core.IJavaThread)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getThreadFilter(org.eclipse.wst.jsdt.debug.core.IJavaDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getThreadFilters()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#removeThreadFilter(org.eclipse.wst.jsdt.debug.core.IJavaDebugTarget)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#addInstanceFilter(org.eclipse.wst.jsdt.debug.core.IJavaObject)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#getInstanceFilters()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#removeInstanceFilter(org.eclipse.wst.jsdt.debug.core.IJavaObject)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#supportsInstanceFilters()
	 */
	public boolean supportsInstanceFilters() {
		return true;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.debug.core.IJavaBreakpoint#supportsThreadFilters()
	 */
