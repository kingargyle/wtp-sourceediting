...
import org.eclipse.wst.jsdt.internal.debug.core.logicalstructures.JDIPlaceholderVariable;
...
public class ArrayRuntimeContext extends AbstractRuntimeContext {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#getVM()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#getThis()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#getReceivingType()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#getLocals()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#getThread()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.internal.debug.eval.ast.engine.IRuntimeContext#isConstructor()
	 */
