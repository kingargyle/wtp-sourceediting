...
import org.eclipse.jsdt.core.dom.ASTNode;
...
import org.eclipse.jsdt.core.dom.Expression;
...
import org.eclipse.jsdt.core.dom.IBinding;
import org.eclipse.jsdt.core.dom.IMethodBinding;
import org.eclipse.jsdt.core.dom.IPackageBinding;
import org.eclipse.jsdt.core.dom.ITypeBinding;
import org.eclipse.jsdt.core.dom.IVariableBinding;
...
import org.eclipse.jsdt.core.dom.Name;
...
import org.eclipse.jsdt.core.dom.Statement;
...
import org.eclipse.jsdt.core.dom.Type;
...
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.AndAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.AndOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ArrayAllocation;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ArrayInitializerInstruction;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.AssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Cast;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.CompoundInstruction;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ConditionalJump;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Constructor;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.DivideAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.DivideOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Dup;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.DupX1;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.EqualEqualOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.GreaterEqualOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.GreaterOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.InstanceOfOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Instruction;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.InstructionSequence;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Jump;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.LeftShiftAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.LeftShiftOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.LessEqualOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.LessOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.LocalVariableCreation;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.MinusAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.MinusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.MultiplyAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.MultiplyOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.NoOp;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.NotOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.OrAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.OrOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PlusAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PlusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Pop;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PostfixMinusMinusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PostfixPlusPlusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PrefixMinusMinusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PrefixPlusPlusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushArrayLength;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushArrayType;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushBoolean;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushChar;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushClassLiteralValue;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushDouble;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushFieldVariable;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushFloat;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushInt;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushLocalVariable;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushLong;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushNull;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushStaticFieldVariable;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushString;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushThis;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.PushType;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.RemainderAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.RemainderOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ReturnInstruction;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.RightShiftAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.RightShiftOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.SendMessage;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.SendStaticMessage;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ThrowInstruction;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.TwiddleOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.UnaryMinusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.UnaryPlusOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.UnsignedRightShiftAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.UnsignedRightShiftOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.Value;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.XorAssignmentOperator;
import org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.XorOperator;
...
public class ASTInstructionCompiler extends ASTVisitor {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#endVisit(org.eclipse.jsdt.core.dom.EnhancedForStatement)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.AnnotationTypeDeclaration)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.AnnotationTypeMemberDeclaration)
	 */
	...
	public boolean visit(ArrayAccess node) {
		...
		push(new org.eclipse.wst.jsdt.internal.debug.eval.ast.instructions.ArrayAccess(fCounter));
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.BlockComment)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.EnhancedForStatement)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.EnumConstantDeclaration)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.EnumDeclaration)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.LineComment)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.MarkerAnnotation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.MemberRef)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.MemberValuePair)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.MethodRef)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.MethodRefParameter)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.Modifier)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.NormalAnnotation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.ParameterizedType)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.QualifiedType)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.SingleMemberAnnotation)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.TagElement)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.TextElement)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.TypeParameter)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.jsdt.core.dom.ASTVisitor#visit(org.eclipse.jsdt.core.dom.WildcardType)
	 */
