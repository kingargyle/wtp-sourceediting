 ...
 *******************************************************************************/
package org.eclipse.wst.javascript.common.ui;
...
import org.eclipse.wst.javascript.core.jsparser.node.TIdentifier;
import org.eclipse.wst.javascript.core.jsparser.node.Token;
import org.eclipse.wst.javascript.core.langlexer.ITokenCache;
import org.eclipse.wst.javascript.core.langlexer.LexerFactory;
...
public class LexerCacheForJavaScript implements ITokenCache {
	...
	public TextRange notifyChange(String strNew, int posChange, int lenOld, int lenNew) {
		...
		if (lenNew < 0)
			throw new RuntimeException(JSCommonUIMessages.getResourceString("internal_error_1")); //$NON-NLS-1$
		//if (lenOld<0) throw new RuntimeException( "internal error: can't pass a negative lenNew to LCFJS.notifyChange" );
		if (strNew == null)
			throw new RuntimeException(JSCommonUIMessages.getResourceString("internal_error_2")); //$NON-NLS-1$
