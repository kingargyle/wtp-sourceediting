 ...
 *******************************************************************************/
package org.eclipse.wst.javascript.common.ui.internal.preferences.ui;
...
import org.eclipse.wst.javascript.common.ui.internal.preferences.OverlayPreferenceStore;
import org.eclipse.wst.javascript.common.ui.internal.preferences.OverlayPreferenceStore.OverlayKey;
import org.eclipse.wst.javascript.common.ui.internal.style.IStyleConstantsJavaScript;
...
public class JavaScriptColorPage extends AbstractColorPage {
	...
	protected void initDescriptions(Dictionary descriptions) {
		...
		descriptions.put(IStyleConstantsJavaScript.DEFAULT, JSCommonUIMessages.getResourceString("%Default_Code_UI_")); //$NON-NLS-1$ = "Default Code"
		descriptions.put(IStyleConstantsJavaScript.KEYWORD, JSCommonUIMessages.getResourceString("%Keywords_UI_")); //$NON-NLS-1$ = "Keywords"
		descriptions.put(IStyleConstantsJavaScript.LITERAL, JSCommonUIMessages.getResourceString("%Literal_Strings_UI_")); //$NON-NLS-1$ = "Literal Strings"
		descriptions.put(IStyleConstantsJavaScript.COMMENT, JSCommonUIMessages.getResourceString("%Comments_UI_")); //$NON-NLS-1$ = "Comments"
		descriptions.put(IStyleConstantsJavaScript.UNFINISHED_COMMENT, JSCommonUIMessages.getResourceString("%Unfinished_Strings_and_Comments_UI_")); //$NON-NLS-1$ = "Unfinished Strings and Comments"
