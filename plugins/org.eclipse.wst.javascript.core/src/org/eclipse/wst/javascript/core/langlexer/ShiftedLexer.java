 ...
 *******************************************************************************/
package org.eclipse.wst.javascript.core.langlexer;
...
public class ShiftedLexer implements IRawLexer {
	...
	protected org.eclipse.wst.javascript.core.jsparser.node.Token tkFirst = null;
	...
	public ShiftedLexer(IRawLexer sublexer, java.io.PushbackReader in, org.eclipse.wst.javascript.core.jsparser.node.Token tk) {
		// super(in);
		this.sublexer = sublexer;
		tkFirst = tk;
